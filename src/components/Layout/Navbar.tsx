...
import { Search, Bell, Menu, CheckCircle2, LogIn, LogOut, ShieldCheck } from 'lucide-react';
...
export const Navbar: React.FC<NavbarProps> = ({ onToggleSidebar, onOpenSearch }) => {
  const { user, role, classInfo, firebaseUser, loginWithGoogle, logoutGoogle, isSuperAdmin } = useAuth();
